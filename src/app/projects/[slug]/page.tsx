...
async function getData(slug: string) {
  const [project, settings] = await Promise.all([
    ...
    safeDb(
      `project detail settings ${slug} (vi)`,
      () =>
...
export async function generateMetadata({
  ...
  return buildMetadata({
    locale: 'vi',
    path: `/projects/${slug}`,
    title: project.metaTitleVi || project.nameVi,
    description: project.metaDescVi || project.shortDescVi || project.descriptionVi || '',
