...
export default function ContactForm({ content, locale }) {
  ...
  const labels = {
    ...
    privacy: locale === "en"
      ? "Your information will only be used for consultation follow-up via sales@networkai.vn or letatkhoa@gmail.com and will not be shared with third parties."
      : "Thông tin của bạn sẽ được sử dụng để liên hệ tư vấn qua sales@networkai.vn hoặc letatkhoa@gmail.com và không chia sẻ cho bên thứ ba."
  };
  ...
  return (
    <div className="contact-form">
      ...
      <p>
        {locale === "en"
          ? "Share your requirements and our team will get back to you via sales@networkai.vn or letatkhoa@gmail.com to discuss the most suitable solution."
          : "Gửi thông tin nhu cầu, đội ngũ của chúng tôi sẽ liên hệ lại qua sales@networkai.vn hoặc letatkhoa@gmail.com để tư vấn giải pháp phù hợp."}
      </p>
